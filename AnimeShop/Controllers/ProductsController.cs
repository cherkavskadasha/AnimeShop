...
namespace AnimeShop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            ...
            ViewData["AverageRating"] = product.Reviews.Any() ? product.Reviews.Average(r => r.Rating) : 0;

            if (Request.Cookies.ContainsKey("CustomerId"))
            {
                ViewData["CustomerId"] = int.Parse(Request.Cookies["CustomerId"]);
            }
            ...
            if (HttpContext.Request.Method == "POST")
            {
                ...
                {
                    ReviewId = int.Parse($"{DateTime.Now.Second}{(int)ViewData["CustomerId"]}"),
